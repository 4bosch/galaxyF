...
public class Bonus2 extends InteractiveTileObject {
    public Bonus2(World world, TiledMap map, Rectangle bounds){
        super(world, map, bounds);
        fixture.setUserData(this);
        setCategoryFilter(GalaxyFighter.BONUS2_BIT);
    }

    @Override
    public void OnHit() {

        Gdx.app.log("Bonus2","Collision");
