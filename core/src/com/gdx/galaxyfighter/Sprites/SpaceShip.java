...
public class SpaceShip extends Sprite {
    ...
    public void defineSpaceShip(){
        ...
        head_spaceship.set(new Vector2(-4/GalaxyFighter.PPM, 0/GalaxyFighter.PPM), new Vector2(4/GalaxyFighter.PPM, 0/GalaxyFighter.PPM));
        ...
        head_spaceship2.set(new Vector2(0/GalaxyFighter.PPM, -4/GalaxyFighter.PPM), new Vector2(0/GalaxyFighter.PPM, 4/GalaxyFighter.PPM));
